...
enum RuuviAssets {
    ...
    static let sensors = "onboarding_sensors"
    static let history = "onboarding_history"
    static let alerts = "onboarding_alerts"
    static let share = "onboarding_share"
    static let widgets = "onboarding_widgets"
