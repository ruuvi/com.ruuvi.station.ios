    ...
    private func updateTopActionButtonVisibility() {
        ...
        case .ruuvi:
            if let isAlertAvailable = viewModel.isAlertAvailable.value {
                ...
                alertButton.isHidden = !viewModel.isConnected.value.bound || viewModel.serviceUUID.value == nil
                alertButtonHidden.isUserInteractionEnabled = viewModel.isConnected.value.bound || viewModel.serviceUUID.value != nil
            }
        }
    }
