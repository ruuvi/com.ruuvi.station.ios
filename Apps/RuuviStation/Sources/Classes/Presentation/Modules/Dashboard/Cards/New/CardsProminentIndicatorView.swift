...
class CardsProminentIndicatorView: UIView {
    ...
    private func setupConstraintSets() {
        ...
        aqiIndicatorHiddenConstraints = [
            ...
            measurementIndicatorContainer.heightAnchor.constraint(equalToConstant: HeightConstants.measurementContainerHeight),
            ...
            measurementUnitLabel.trailingAnchor.constraint(lessThanOrEqualTo: measurementIndicatorContainer.trailingAnchor),
        ]
    }
