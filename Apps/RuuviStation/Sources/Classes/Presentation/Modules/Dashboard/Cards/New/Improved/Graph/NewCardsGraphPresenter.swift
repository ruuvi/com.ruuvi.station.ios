...
class NewCardsGraphPresenter: NSObject {
...
extension NewCardsGraphPresenter: CardsGraphPresenterInput {
    func configure(
...
extension NewCardsGraphPresenter {
...
extension NewCardsGraphPresenter: TagChartsViewInteractorOutput {
