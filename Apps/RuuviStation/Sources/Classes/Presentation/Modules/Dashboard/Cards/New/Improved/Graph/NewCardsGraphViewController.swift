...
class NewCardsGraphViewController: UIViewController {
    weak var output: NewCardsGraphViewOutput?

    init(output: NewCardsGraphViewOutput) {
        self.output = output
...
extension NewCardsGraphViewController: TagChartsViewDelegate {
...
extension NewCardsGraphViewController: NewCardsGraphViewInput {
...
extension NewCardsGraphViewController {
...
extension NewCardsGraphViewController: UIScrollViewDelegate {
