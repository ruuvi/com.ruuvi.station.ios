...
extension RuuviTagCardSnapshot {
    ...
    // MARK: - Update Connection Data (Optimized)
    ...
    // MARK: - Update Background Image (Optimized)
    ...
    // MARK: - Update Network Sync Status (Optimized)
    ...
    // MARK: - Update Alert for Specific Measurement Type (Optimized)
    func updateAlert(
    ...
    // MARK: - Update Overall Alert State (Optimized)
    ...
    // MARK: - Sync All Alerts from Service (Optimized)
    func syncAllAlerts(
    ...
    // MARK: - Update from RuuviTagSensorRecord (Optimized)
