...
// MARK: - Helper Methods
private extension NewDashboardPresenter {
    ...
    func openTagSettings(for snapshot: RuuviTagCardSnapshot, sensor: AnyRuuviTagSensor) {
        ...
        router.openTagSettings(
            ruuviTag: sensor,
            latestMeasurement: nil, // Would need to extract from snapshot
...
extension NewDashboardPresenter: RuuviTagDataServiceDelegate {
...
extension NewDashboardPresenter: RuuviTagAlertServiceDelegate {
...
extension NewDashboardPresenter: RuuviTagBackgroundServiceDelegate {
...
extension NewDashboardPresenter: RuuviTagConnectionServiceDelegate {
...
extension NewDashboardPresenter: DashboardSettingsServiceDelegate {
...
extension NewDashboardPresenter: DashboardCloudSyncServiceDelegate {
