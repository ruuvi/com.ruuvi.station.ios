...
struct RuuviTagDashboardCellLayoutConstants {
    // Card padding
...
class RuuviTagDashboardCell: UICollectionViewCell, TimestampUpdateable {
    ...
    private lazy var ruuviTagNameLabel: UILabel = {
        ...
        label.numberOfLines = RuuviTagDashboardCellLayoutConstants.maxNameLines
        label.font = RuuviTagDashboardCellLayoutConstants.nameFont
        label
    ...
    private lazy var moreIconView: UIView = {
        ...
        iv
            .anchor(
                ...
                trailing: view.trailingAnchor,
                padding: .init(
                    top: RuuviTagDashboardCellLayoutConstants.moreIconTopPadding,
                    left: 8,
                    bottom: 2,
                    right: 8
                )
    ...
    private lazy var rowsStackView: UIStackView = {
        ...
        stackView.spacing = RuuviTagDashboardCellLayoutConstants.gridRowSpacing
    ...
    private lazy var updatedAtLabel: UILabel = {
        ...
        label.font = RuuviTagDashboardCellLayoutConstants.timestampFont
        return label
    }()
    ...
    override func prepareForReuse() {
        ...
        dataSourceIconViewWidthConstraint.constant = RuuviTagDashboardCellLayoutConstants.sourceIconCompactWidth
        ...
        if dashboardType == .image {
            ...
            nameLeadingConstraint = ruuviTagNameLabel.leadingAnchor
                .constraint(
                    ...
                    constant: RuuviTagDashboardCellLayoutConstants.nameToImageSpacing
                )
            ...
            gridTopConstraint = rowsStackView.topAnchor
                .constraint(
                    ...
                    constant: RuuviTagDashboardCellLayoutConstants.groupSpacing
                )
            ...
            nameLeadingConstraint = ruuviTagNameLabel.leadingAnchor
                .constraint(
                    ...
                    constant: RuuviTagDashboardCellLayoutConstants.leadingPadding
                )
            nameLeadingConstraint.isActive = true
            ...
            gridTopConstraint = rowsStackView.topAnchor
                .constraint(
                    ...
                    constant: RuuviTagDashboardCellLayoutConstants.headerToGridSpacing
                )
            gridTopConstraint.isActive = true
    ...
    private func buildGrid(
        ...
        rowsStackView.spacing = RuuviTagDashboardCellLayoutConstants.gridRowSpacing
        ...
        if indicators.count < 3 {
            ...
            for indicator in indicators {
                ...
                indicator
                    .constrainHeight(
                        constant: RuuviTagDashboardCellLayoutConstants.gridRowHeight
                    )
                rowsStackView
                    .addArrangedSubview(
                        indicator
    ...
    private func updateSourceIcon(
        ...
        switch source {
        case .ruuviNetwork:
            dataSourceIconViewWidthConstraint.constant = RuuviTagDashboardCellLayoutConstants.sourceIconRegularWidth
        default:
            dataSourceIconViewWidthConstraint.constant = RuuviTagDashboardCellLayoutConstants.sourceIconCompactWidth
        }
    ...
    private func setupUI() {
        ...
        cardBackgroundView.widthAnchor
            .constraint(
                ...
                multiplier: RuuviTagDashboardCellLayoutConstants.imageWidthRatio
            ).isActive = true
        cardBackgroundView.isHidden = true
        ...
        moreIconView
            .anchor(
                ...
                size: .init(
                    width: RuuviTagDashboardCellLayoutConstants.moreIconSize,
                    height: RuuviTagDashboardCellLayoutConstants.moreIconSize
                )
            )
        ...
        alertIconView
            .anchor(
                ...
                padding: .init(
                    top: RuuviTagDashboardCellLayoutConstants.topPadding,
                    left: 0,
                    bottom: 0,
                    right: 0
                ),
                size: RuuviTagDashboardCellLayoutConstants.alertIconSize
            )
        ...
        prominentGroupContainer
            .anchor(
                ...
                trailing: containerView.trailingAnchor,
                padding: .init(
                    top: RuuviTagDashboardCellLayoutConstants.groupSpacing,
                    left: 0,
                    bottom: 0,
                    right: RuuviTagDashboardCellLayoutConstants.trailingPadding
                )
            )
        prominentGroupContainer
            .constrainHeight(
                constant: RuuviTagDashboardCellLayoutConstants.prominentViewHeight
            )
        prominentGroupContainer.isHidden = true
        ...
        progressViewContainer
            .anchor(
                ...
                trailing: nil,
                padding: .init(
                    top: RuuviTagDashboardCellLayoutConstants.progressViewTopSpacing,
                    left: 0,
                    bottom: 0,
                    right: 0
                ),
                size: .init(
                    width: 120,
                    height: RuuviTagDashboardCellLayoutConstants.progressViewHeight
                )
            )
        ...
        sourceAndUpdateStack.spacing = RuuviTagDashboardCellLayoutConstants.sourceIconToTextSpacing
        sourceAndUpdateStack.distribution = .fill

        dataSourceIconViewWidthConstraint = dataSourceIconView.widthAnchor
            .constraint(
                lessThanOrEqualToConstant: RuuviTagDashboardCellLayoutConstants.sourceIconRegularWidth
            )
        ...
        footerStack
            .anchor(
                ...
                trailing: containerView.trailingAnchor,
                padding: .init(
                    top: RuuviTagDashboardCellLayoutConstants.gridToFooterSpacing,
                    left: 0,
                    bottom: RuuviTagDashboardCellLayoutConstants.bottomPadding,
                    right: RuuviTagDashboardCellLayoutConstants.footerTrailingPadding
                )
            )
        ...
        footerStack
            .constrainHeight(
                constant: RuuviTagDashboardCellLayoutConstants.footerHeight
            )
        batteryLevelView.isHidden = true
...
extension RuuviTagDashboardCell {
    ...
    private static func calculateSimpleHeight(
        ...
        let gridHeight = RuuviTagDashboardCellLayoutConstants.gridHeight(
        ...
        let totalHeight = nameHeight +
                          RuuviTagDashboardCellLayoutConstants.totalVerticalSpacing +
                          gridHeight +
                          RuuviTagDashboardCellLayoutConstants.footerHeight
    ...
    private static func calculateImageHeight(
        ...
        let prominentHeight = RuuviTagDashboardCellLayoutConstants.prominentViewHeight
        let progressHeight = hasAQI ? (
            RuuviTagDashboardCellLayoutConstants.progressViewTopSpacing +
            RuuviTagDashboardCellLayoutConstants.progressViewHeight
        ) : 0
        let indicatorCount = snapshot.displayData.indicatorGrid?.indicators.count ?? 0
        let gridHeight = RuuviTagDashboardCellLayoutConstants.gridHeight(
            indicatorCount: indicatorCount,
        ...
        let totalHeight = RuuviTagDashboardCellLayoutConstants.topPadding +
        nameHeight +
        RuuviTagDashboardCellLayoutConstants.groupSpacing +
        prominentHeight +
        progressHeight +
        RuuviTagDashboardCellLayoutConstants.groupSpacing +
        gridHeight +
        RuuviTagDashboardCellLayoutConstants.gridToFooterSpacing +
        RuuviTagDashboardCellLayoutConstants.footerHeight +
        RuuviTagDashboardCellLayoutConstants.bottomPadding
    ...
    private static func calculateNameLabelHeight(
        ...
        let availableWidth = RuuviTagDashboardCellLayoutConstants.availableNameWidth(
        ...
        let textRect = (
            ...
            attributes: [.font: RuuviTagDashboardCellLayoutConstants.nameFont],
            context: nil
        )
        ...
        let singleLineHeight = ceil(
            RuuviTagDashboardCellLayoutConstants.nameFont.lineHeight
        )
        let maxHeight = singleLineHeight * CGFloat(
            RuuviTagDashboardCellLayoutConstants.maxNameLines
        )
