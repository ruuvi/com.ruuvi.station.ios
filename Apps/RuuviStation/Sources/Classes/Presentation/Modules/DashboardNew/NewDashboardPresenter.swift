...
class NewDashboardPresenter: DashboardModuleInput {
    ...
    private var lastRecordObserveTokens = [RuuviReactorToken]()
    private var lastRecordObserveToken: RuuviReactorToken?
    ...
    private var itemsByID: [String: RuuviSensorCardItem] = [:]
...
extension NewDashboardPresenter: DashboardViewOutput {
    func viewDidLoad() {
...
//                sSelf.restartObservingRuuviTagLastRecords()
                sSelf.restartObservingLastRecords()
            ...
            case let .insert(sensor):
                ...
                sSelf.handleTagInserted(sensor)
