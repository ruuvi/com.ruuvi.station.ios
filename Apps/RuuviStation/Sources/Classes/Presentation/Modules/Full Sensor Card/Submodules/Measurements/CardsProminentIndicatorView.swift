...
class CardsProminentIndicatorView: UIView {
    ...
    deinit {
        titleContainerAlertBorderLayer
            .removeAllAnimations()
    }
    ...
    private func setupView() {
        ...
        viewHeightConstraint = heightAnchor
            .constraint(
                equalToConstant: HeightConstants.measurementModeHeight
            )
        ...
        NSLayoutConstraint
            .activate(
                [
                    indicatorTitleContainer.bottomAnchor
                        .constraint(
                            equalTo: bottomAnchor
                        ),
                    indicatorTitleContainer.centerXAnchor
                        .constraint(
                            equalTo: centerXAnchor
                        ),
                    indicatorTitleContainer.heightAnchor
                        .constraint(
                            equalToConstant: HeightConstants.titleContainerHeight
                        ),
                ]
            )
    ...
    private func updateTitleContainerAlertBorderPath() {
        guard titleContainerAlertBorderLayer.superlayer != nil else {
            return
        }
    ...
    private func setupConstraintSets() {
        ...
        aqiIndicatorVisibleConstraints = [
            aqiIndicatorView.topAnchor
                .constraint(
                    equalTo: topAnchor
                ),
            aqiIndicatorView.bottomAnchor
                .constraint(
                    equalTo: indicatorTitleContainer.topAnchor,
                    constant: -HeightConstants.spacingToTitle
                ),
            aqiIndicatorView.centerXAnchor
                .constraint(
                    equalTo: centerXAnchor
                ),
            aqiIndicatorView.widthAnchor
                .constraint(
                    equalToConstant: HeightConstants.aqiCircularViewSize
                ),
            aqiIndicatorView.heightAnchor
                .constraint(
                    equalToConstant: HeightConstants.aqiCircularViewSize
                ),
        ]
        ...
        aqiIndicatorHiddenConstraints = [
            ...
            measurementIndicatorContainer.topAnchor
                .constraint(
                    equalTo: topAnchor
                ),
            measurementIndicatorContainer.bottomAnchor
                .constraint(
                    equalTo: indicatorTitleContainer.topAnchor,
                    constant: -HeightConstants.spacingToTitle
                ),
            ...
            measurementIndicatorContainer.heightAnchor
                .constraint(
            ...
            measurementValueLabel.centerYAnchor
                .constraint(
                    equalTo: measurementIndicatorContainer.centerYAnchor
                ),
            ...
            measurementUnitLabel.topAnchor
                .constraint(
                    equalTo: measurementValueLabel.topAnchor,
                    constant: 12
                ),
            measurementUnitLabel.leadingAnchor
                .constraint(
                    equalTo: measurementValueLabel.trailingAnchor,
                    constant: 4
                ),
            measurementUnitLabel.trailingAnchor
                .constraint(
    ...
    @objc private func handleTap() {
        guard let indicatorData else {
            return
        }
        delegate?
            .cardsProminentIndicatorViewDidTap(
                for: indicatorData,
                sender: self
            )
    }
    ...
    private func startAlertBorderAnimation() {
        ...
        guard titleContainerAlertBorderLayer
            .animation(
        ...
        self.titleContainerAlertBorderLayer
            .add(
                animation,
                forKey: "pulseAnimation"
            )
    ...
    private func stopAlertBorderAnimation() {
        ...
        DispatchQueue.main
            .asyncAfter(
                ...
                guard let self = self, !self.currentAlertState else {
                    return
                }
    ...
    func restartAlertAnimationIfNeeded() {
        ...
        if currentAlertState && titleContainerAlertBorderLayer
            .animation(
                forKey: "pulseAnimation"
            ) == nil {
            startAlertBorderAnimation()
        ...
        maxValueLabel
            .anchor(
                ...
                padding: UIEdgeInsets(
                    top: Constants.labelVerticalSpacing,
                    left: 0,
                    bottom: 0,
                    right: 0
                )
...
class CircularProgressView: UIView {
    ...
    private func updateTipPosition() {
        ...
        let progressAngle = Constants.startAngle + (
            Constants.totalArcAngle * CGFloat(
                currentProgress
            )
        )

        // Calculate tip position
        let tipX = center.x + radius * cos(
            progressAngle
        )
        let tipY = center.y + radius * sin(
            progressAngle
        )
    ...
    private func createGlowEffect(
        ...
        glowGradient.startPoint = CGPoint(
            x: 0.5,
            y: 0.5
        )
        glowGradient.endPoint = CGPoint(
            x: 1.0,
            y: 1.0
        )
        ...
        outerGlowGradient.startPoint = CGPoint(
            x: 0.5,
            y: 0.5
        )
        outerGlowGradient.endPoint = CGPoint(
            x: 1.0,
            y: 1.0
        )

        let outerGlowMask = CAShapeLayer()
        let outerGlowPath = UIBezierPath(
            ovalIn: CGRect(
                x: 0,
                y: 0,
                width: Constants.outerGlowSize,
    ...
    func setProgress(
        ...
        progressLayer.strokeEnd = CGFloat(
            clampedProgress
        )
        updateProgressAppearance()
    }
