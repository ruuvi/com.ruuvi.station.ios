...
private extension CardsProminentIndicatorView {
    ...
    func setupMeasurementConstraints() {
        //  Align measurementValueLabel with the same vertical center as currentValueLabel in AQI mode
        // The currentValueLabel is centered in the circular view which is 150px tall
        // The circular view is centered within the aqiIndicatorView (176px tall)
        // So the currentValueLabel is at vertical center of the aqiIndicatorView = 88px from top
        let aqiValueLabelCenterY = Constants.aqiCircularViewSize / 2
        ...
        aqiIndicatorHiddenConstraints = [
            ...
            measurementValueLabel.centerYAnchor.constraint(
                ...
                constant: aqiValueLabelCenterY - 3
            ),
...
private extension AirQualityCircularView {
    ...
    func setupCurrentValueConstraints() {
        ...
        NSLayoutConstraint.activate(
[
            currentValueLabel.centerXAnchor.constraint(equalTo: circularProgressView.centerXAnchor),
    ...
    func setupStatusLabelConstraints() {
        // Update status label to be positioned relative to the circular progress view
        NSLayoutConstraint.activate([
