...
private extension CardsSettingsAlertsBuilder {
    static func makeSection(
        ...
        let legacyTitle = legacyAlertTitle(for: type, measurementService: measurementService)
        let title = alertTitle(for: type)
...
private extension CardsSettingsAlertsBuilder {
    ...
    static func alertTitle(for alertType: AlertType) -> String {
        switch alertType {
        case .temperature:
