...
extension CardsMeasurementDetailsView {
    ...
    static func createSheet(from indicator: RuuviTagCardSnapshotIndicatorData) -> CardsMeasurementDetailsView {
...
private extension CardsMeasurementDetailsView {
    ...
    static func processIndicatorValue(_ indicator: RuuviTagCardSnapshotIndicatorData) -> String {
