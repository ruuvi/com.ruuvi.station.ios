...
class TagSettingsViewController: UIViewController {
    ...
    private lazy var moreInfoPm1Cell: TagSettingsPlainCell? = TagSettingsPlainCell(
        style: .value1,
        reuseIdentifier: Self.ReuseIdentifier
    )

    private lazy var moreInfoPm4Cell: TagSettingsPlainCell? = TagSettingsPlainCell(
        style: .value1,
        reuseIdentifier: Self.ReuseIdentifier
    )

    private lazy var moreInfoPm10Cell: TagSettingsPlainCell? = TagSettingsPlainCell(
        style: .value1,
        reuseIdentifier: Self.ReuseIdentifier
    )
...
extension TagSettingsViewController {
    ...
    private func moreInfoPM1Item() -> TagSettingsItem {
        let settingItem = TagSettingsItem(
            createdCell: { [weak self] in
    ...
    private func moreInfoPM4Item() -> TagSettingsItem {
        let settingItem = TagSettingsItem(
            createdCell: { [weak self] in
    ...
    private func moreInfoPM10Item() -> TagSettingsItem {
        let settingItem = TagSettingsItem(
            createdCell: { [weak self] in
