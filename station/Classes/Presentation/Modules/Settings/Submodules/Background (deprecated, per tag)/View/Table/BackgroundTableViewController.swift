        ...
        case .keepConnection:
            ...
            let cell = tableView
                .dequeueReusableCell(withIdentifier: switchCellReuseIdentifier,
                                     for: indexPath) as! BackgroundSwitchTableViewCell
        ...
        case .saveHeartbeatsInterval:
            ...
            let cell = tableView
                .dequeueReusableCell(withIdentifier: stepperCellReuseIdentifier,
                                     for: indexPath) as! BackgroundStepperTableViewCell
            // swiftlint:enable force_cast
            cell.titleLabel.text = "Background.Interval.Every.string".localized()
