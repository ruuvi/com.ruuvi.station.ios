...
class TagActionsPresentTransitionAnimation: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let initialFrame = CGRect(x: appearedFrame.origin.x , y: TagActionsTransitionManager.appScreenRect.height, width: appearedFrame.size.width, height: appearedFrame.size.height)
    ...
    func handlePresent(_ pan: UIPanGestureRecognizer) {
        ...
        if !manager.isInteractive {
            ...
            manager.container.present(manager.actions, animated: true)
        }
