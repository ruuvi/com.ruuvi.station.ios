...
extension TagSettingsPresenter {
    ...
    private func syncViewModel() {
        ...
        if let luid = ruuviTag.luid {
            ...
            viewModel.relativeHumidityAlertDescription.value = alertService.relativeHumidityDescription(for: macId.value)
            viewModel.absoluteHumidityAlertDescription.value = alertService.absoluteHumidityDescription(for: macId.value)
