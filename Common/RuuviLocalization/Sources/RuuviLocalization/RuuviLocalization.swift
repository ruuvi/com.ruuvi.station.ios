...
public enum RuuviLocalization {
    ...
    public static func alertCloudConnectionDescription(_ p1: Int) -> String {
        RuuviLocalization.tr("Localizable", "alert_cloud_connection_description", p1, fallback: "Alert if sensor data hasn't been updated to the cloud for longer than %d minutes.")
    }
    ...
    public static func alertNotificationHumidityHighThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_humidity_high_threshold", String(describing: p1), fallback: "Air Humidity is above %@")
    }

    /// Air Humidity is below %@
    public static func alertNotificationHumidityLowThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_humidity_low_threshold", String(describing: p1), fallback: "Air Humidity is below %@")
    }

    /// Air Pressure is above %@
    public static func alertNotificationPressureHighThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_pressure_high_threshold", String(describing: p1), fallback: "Air Pressure is above %@")
    }

    /// Air Pressure is below %@
    public static func alertNotificationPressureLowThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_pressure_low_threshold", String(describing: p1), fallback: "Air Pressure is below %@")
    }

    /// Signal strength is above %@
    public static func alertNotificationRssiHighThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_rssi_high_threshold", String(describing: p1), fallback: "Signal strength is above %@")
    }

    /// Signal strength is below %@
    public static func alertNotificationRssiLowThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_rssi_low_threshold", String(describing: p1), fallback: "Signal strength is below %@")
    }

    /// Temperature is above %@
    public static func alertNotificationTemperatureHighThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_temperature_high_threshold", String(describing: p1), fallback: "Temperature is above %@")
    }

    /// Temperature is below %@
    public static func alertNotificationTemperatureLowThreshold(_ p1: Any) -> String {
        RuuviLocalization.tr("Localizable", "alert_notification_temperature_low_threshold", String(describing: p1), fallback: "Temperature is below %@")
    }
    ...
    public static func dayX(_ p1: Float) -> String {
        RuuviLocalization.tr("Localizable", "day_x", p1, fallback: "%.0f days")
    }
    ...
    public static func readingHistoryX(_ p1: Float) -> String {
        RuuviLocalization.tr("Localizable", "reading_history_x", p1, fallback: "Reading Bluetooth: %.0f")
    }
    ...
    public static func sharedToX(_ p1: Int, _ p2: Int) -> String {
        RuuviLocalization.tr("Localizable", "shared_to_x", p1, p2, fallback: "Shared to %d/%d")
    }
    ...
    public static func uploadingProgress(_ p1: Float) -> String {
        RuuviLocalization.tr("Localizable", "uploading_progress", p1, fallback: "Uploading: %.0f")
    }
    ...
    public enum About {
        ...
        public enum DatabaseSize {
            ...
            public static func text(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "About.DatabaseSize.text", String(describing: p1), fallback: "Database size: %@")
            }
        }
        ...
        public enum MeasurementsCount {
            ...
            public static func text(_ p1: Int) -> String {
                RuuviLocalization.tr("Localizable", "About.MeasurementsCount.text", p1, fallback: "Number of locally stored measurements: %d")
            }
        }
        ...
        public enum TagsCount {
            /// Added sensors: %d
            public static func text(_ p1: Int) -> String {
                RuuviLocalization.tr("Localizable", "About.TagsCount.text", p1, fallback: "Added sensors: %d")
            }
        }
        ...
        public enum Alert {
            public enum AlreadyLoggedIn {
                ...
                public static func message(_ p1: Any) -> String {
                    RuuviLocalization.tr("Localizable", "Cards.Alert.AlreadyLoggedIn.message", String(describing: p1), fallback: "User %@ is already signed in. If you'd like to use a different account, please sign out first and then try again.")
                }
            }
        }
    ...
    public enum ExportService {
        ...
        public static func dewPoint(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "ExportService.DewPoint", String(describing: p1), fallback: "Dew point (%@)")
        }

        /// Humidity (%@)
        public static func humidity(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "ExportService.Humidity", String(describing: p1), fallback: "Humidity (%@)")
        }
        ...
        public static func pressure(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "ExportService.Pressure", String(describing: p1), fallback: "Pressure (%@)")
        }

        /// Temperature (%@)
        public static func temperature(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "ExportService.Temperature", String(describing: p1), fallback: "Temperature (%@)")
        }
    ...
    public enum HumidityCalibration {
        ...
        public enum LastCalibrationDate {
            ...
            public static func format(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "HumidityCalibration.lastCalibrationDate.format", String(describing: p1), fallback: "Calibrated: %@")
            }
        }
    }
    ...
    public enum HumidityUnit {
        public enum Dew {
            ...
            public static func title(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "HumidityUnit.Dew.title", String(describing: p1), fallback: "Dew point (%@)")
            }
        }
    ...
    public enum MenuTableViewController {
        ...
        public static func user(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "MenuTableViewController.User", String(describing: p1), fallback: "User: %@")
        }
    }
        ...
        public enum Dialog {
            public enum Calibration {
                ...
                public static func enterHumidity(_ p1: Any) -> String {
                    RuuviLocalization.tr("Localizable", "OffsetCorrection.Dialog.Calibration.EnterHumidity", String(describing: p1), fallback: "Enter the expected humidity value from sensor under current conditions (%@): ")
                }

                /// Enter the expected pressure value from sensor under current conditions (%@):
                public static func enterPressure(_ p1: Any) -> String {
                    RuuviLocalization.tr("Localizable", "OffsetCorrection.Dialog.Calibration.EnterPressure", String(describing: p1), fallback: "Enter the expected pressure value from sensor under current conditions (%@): ")
                }
                ...
                public static func enterTemperature(_ p1: Any) -> String {
                    RuuviLocalization.tr("Localizable", "OffsetCorrection.Dialog.Calibration.EnterTemperature", String(describing: p1), fallback: "Enter the expected temperature value from sensor under current conditions (%@): ")
                }
    ...
    public enum SharePresenter {
        public enum UnshareSensor {
            ...
            public static func message(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "SharePresenter.UnshareSensor.Message", String(describing: p1), fallback: "Do you want to unshare sensor for %@?")
            }
        }
    }
    ...
    public enum ShareViewController {
        ...
        public enum SharedEmails {
            ...
            public static func title(_ p1: Int, _ p2: Int) -> String {
                RuuviLocalization.tr("Localizable", "ShareViewController.sharedEmails.Title", p1, p2, fallback: "You have used %d/%d of maximum shares of this sensor. The sensor has been shared to following users:")
            }
        }
    }
    ...
    public enum SignIn {
        ...
        public static func checkMailbox(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "SignIn.CheckMailbox", String(describing: p1), fallback: "We've sent a one-time password to your email %@. Sign in by entering it here:")
        }
        ...
        public enum EmailMismatch {
            public enum Alert {
                ...
                public static func message(_ p1: Any, _ p2: Any, _ p3: Any) -> String {
                    RuuviLocalization.tr("Localizable", "SignIn.EmailMismatch.Alert.message", String(describing: p1), String(describing: p2), String(describing: p3), fallback: "Oops, you've requested the code for %@, but used the code for %@. Please double check that you are using the code for %@")
                }
            }
        }
    ...
    public enum TagChartsPresenter {
        ...
        public static func numberOfPointsSynchronizedOverNetwork(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "TagChartsPresenter.NumberOfPointsSynchronizedOverNetwork", String(describing: p1), fallback: "Synchronised: %@")
        }
    }
    ...
    public enum TagSettings {
        ...
        public enum AirHumidityAlert {
            /// Air Humidity (%@)
            public static func title(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "TagSettings.AirHumidityAlert.title", String(describing: p1), fallback: "Air Humidity (%@)")
            }
        }
        ...
        public enum AlertSettings {
            public enum Dialog {
                ...
                public static func max(_ p1: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.AlertSettings.Dialog.Max", p1, fallback: "Max (%.0f)")
                }

                /// Min (%.0f)
                public static func min(_ p1: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.AlertSettings.Dialog.Min", p1, fallback: "Min (%.0f)")
                }
            }
        }
        ...
        public enum Alerts {
            ...
            public enum DewPoint {
                ...
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.Alerts.DewPoint.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Humidity {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.Alerts.Humidity.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Pressure {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.Alerts.Pressure.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Temperature {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.Alerts.Temperature.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
        }
        ...
        public enum HumidityIsClipped {
            public enum Alert {
                ...
                public static func message(_ p1: Float) -> String {
                    RuuviLocalization.tr("Localizable", "TagSettings.HumidityIsClipped.Alert.message", p1, fallback: "Humidity value is greater than 100% after calibration. This value doesn't make sense, so the value has been adjusted to 100%.")
                }
        ...
        public enum PressureAlert {
            /// Air Pressure (%@)
            public static func title(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "TagSettings.PressureAlert.title", String(describing: p1), fallback: "Air Pressure (%@)")
            }
        }
        ...
        public enum TemperatureAlertTitleLabel {
            /// Temperature (%@)
            public static func text(_ p1: Any) -> String {
                RuuviLocalization.tr("Localizable", "TagSettings.temperatureAlertTitleLabel.text", String(describing: p1), fallback: "Temperature (%@)")
            }
        }
    ...
    public enum UserApiError {
        ...
        public static func erSensorAlreadyClaimed(_ p1: Any) -> String {
            RuuviLocalization.tr("Localizable", "UserApiError.ER_SENSOR_ALREADY_CLAIMED", String(describing: p1), fallback: "Sensor already claimed by %@")
        }
    ...
    public enum WebTagSettings {
        ...
        public enum Alerts {
            ...
            public enum DewPoint {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "WebTagSettings.Alerts.DewPoint.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Humidity {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "WebTagSettings.Alerts.Humidity.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Pressure {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "WebTagSettings.Alerts.Pressure.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
            ...
            public enum Temperature {
                /// Alert when less than %.0f or more than %.0f
                public static func description(_ p1: Float, _ p2: Float) -> String {
                    RuuviLocalization.tr("Localizable", "WebTagSettings.Alerts.Temperature.description", p1, p2, fallback: "Alert when less than %.0f or more than %.0f")
                }
            }
        }
