...
public enum RuuviFonts {
    public enum Mulish {
        public static let regular = FontAsset(name: "Mulish-Regular", family: "Mulish", style: "Regular")
        public static let bold = FontAsset(name: "Mulish-Bold", family: "Mulish", style: "Bold")
        public static let extraBold = FontAsset(name: "Mulish-ExtraBold", family: "Mulish", style: "ExtraBold")
        public static let semiBoldItalic = FontAsset(name: "Mulish-SemiBoldItalic", family: "Mulish", style: "SemiBoldItalic")
    }

    public enum Montserrat {
        public static let regular = FontAsset(name: "Montserrat-Regular", family: "Montserrat", style: "Regular")
        public static let bold = FontAsset(name: "Montserrat-Bold", family: "Montserrat", style: "Bold")
        public static let extraBold = FontAsset(name: "Montserrat-ExtraBold", family: "Montserrat", style: "ExtraBold")
    }

    public enum Oswald {
        public static let extraLight = FontAsset(name: "Oswald-ExtraLight", family: "Oswald", style: "ExtraLight")
        public static let light = FontAsset(name: "Oswald-Light", family: "Oswald", style: "Light")
        public static let regular = FontAsset(name: "Oswald-Regular", family: "Oswald", style: "Regular")
        public static let bold = FontAsset(name: "Oswald-Bold", family: "Oswald", style: "Bold")
    }
