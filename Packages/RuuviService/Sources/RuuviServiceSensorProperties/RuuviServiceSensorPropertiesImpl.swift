...
public final class RuuviServiceSensorPropertiesImpl: RuuviServiceSensorProperties {
    ...
    private func pushDisplaySettingsToCloudIfNeeded(
        ...
        let encodedOrder = encodeDisplayOrderForCloud(displayOrder) ?? ""
        let types = ["displayOrder", "defaultDisplayOrder"]
        let values = [
            encodedOrder,
            defaultDisplayOrder ? "true" : "false",
        ]
