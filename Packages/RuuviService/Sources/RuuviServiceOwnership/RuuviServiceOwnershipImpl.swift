...
public final class RuuviServiceOwnershipImpl: RuuviServiceOwnership {
    ...
    public func loadShared(for sensor: RuuviTagSensor) async throws -> Set<AnyShareableSensor> {
        do { return try await cloud.loadShared(for: sensor) } catch { throw RuuviServiceError.ruuviCloud(error.asCloud) }
    }
    ...
    public func share(
        ...
        do { return try await cloud.share(macId: macId, with: email) } catch { throw RuuviServiceError.ruuviCloud(error.asCloud) }
    }

    @discardableResult
    public func unshare(macId: MACIdentifier, with email: String?) async throws -> MACIdentifier {
        do { return try await cloud.unshare(macId: macId, with: email) } catch { throw RuuviServiceError.ruuviCloud(error.asCloud) }
    }
    ...
    public func claim(sensor: RuuviTagSensor) async throws -> AnyRuuviTagSensor {
        ...
        do {
            ...
            throw RuuviServiceError.ruuviCloud(error.asCloud)
        }
    }
    ...
    public func checkOwner(macId: MACIdentifier) async throws -> String? {
        do { return try await cloud.checkOwner(macId: macId) } catch { throw RuuviServiceError.ruuviCloud(error.asCloud) }
    }
