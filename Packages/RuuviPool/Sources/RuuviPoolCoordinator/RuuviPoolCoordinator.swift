...
final class RuuviPoolCoordinator: RuuviPool {
    ...
    func create(_ ruuviTag: RuuviTagSensor) async throws -> Bool {
        ...
        do {
            ...
            return result
        } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
    ...
    func deleteLast(_ ruuviTagId: String) async throws -> Bool {
        do { _ = try await sqlite.deleteLatest(ruuviTagId); return true } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
    ...
    func deleteAllRecords(_ ruuviTagId: String) async throws -> Bool {
        do { _ = try await sqlite.deleteAllRecords(ruuviTagId); return true } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }

    func deleteAllRecords(_ ruuviTagId: String, before date: Date) async throws -> Bool {
        do { _ = try await sqlite.deleteAllRecords(ruuviTagId, before: date); return true } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }

    @discardableResult
    func cleanupDBSpace() async throws -> Bool {
        do { _ = try await sqlite.cleanupDBSpace(); return true } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
    ...
    func updateOffsetCorrection(
        ...
        guard ruuviTag.macId != nil else { assertionFailure(); throw RuuviPoolError.ruuviPersistence(NSError(domain: "invalid", code: -1)) }
        do { return try await sqlite.updateOffsetCorrection(type: type, with: value, of: ruuviTag, lastOriginalRecord: record) } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
    ...
    func createQueuedRequest(
        ...
        do { return try await sqlite.createQueuedRequest(request) } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }

    func deleteQueuedRequest(
        _ request: RuuviCloudQueuedRequest
    ) async throws -> Bool {
        do { return try await sqlite.deleteQueuedRequest(request) } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }

    func deleteQueuedRequests() async throws -> Bool {
        do { return try await sqlite.deleteQueuedRequests() } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
    ...
    func save(
        ...
        do { return try await sqlite.save(subscription: subscription) } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }

    func readSensorSubscriptionSettings(
        _ ruuviTag: RuuviTagSensor
    ) async throws -> CloudSensorSubscription? {
        do { return try await sqlite.readSensorSubscriptionSettings(ruuviTag) } catch { throw RuuviPoolError.ruuviPersistence(error) }
    }
}
