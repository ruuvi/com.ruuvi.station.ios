...
public final class RuuviCloudPure: RuuviCloud {
    ...
    public func setAlert(
        ...
        do {
            ...
            createQueuedRequest(from: request, type: .alert, uniqueKey: uniqueKey)
            notifyListener(state: .failed, macId: macId.mac)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    ...
    public func set(disableEmailAlert: Bool) async throws -> Bool {
        ...
        do { _ = try await api.postSetting(request, authorization: apiKey) } catch {
            createQueuedRequest(from: request, type: .settings, uniqueKey: RuuviCloudApiSetting.emailAlertDisabled.rawValue)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    ...
    public func set(disablePushAlert: Bool) async throws -> Bool {
        ...
        do { _ = try await api.postSetting(request, authorization: apiKey) } catch {
            createQueuedRequest(from: request, type: .settings, uniqueKey: RuuviCloudApiSetting.pushAlertDisabled.rawValue)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    ...
    public func set(profileLanguageCode: String) async throws -> String {
        ...
        do { _ = try await api.postSetting(request, authorization: apiKey) } catch {
            createQueuedRequest(from: request, type: .settings, uniqueKey: RuuviCloudApiSetting.profileLanguageCode.rawValue)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    ...
    public func set(dashboardSensorOrder: [String]) async throws -> [String] {
        ...
        do { _ = try await api.postSetting(request, authorization: apiKey) } catch {
            createQueuedRequest(from: request, type: .settings, uniqueKey: RuuviCloudApiSetting.dashboardSensorOrder.rawValue)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    ...
    public func update(
        ...
        do {
            ...
            createQueuedRequest(from: request, type: .sensor, uniqueKey: uniqueKey)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    }
    ...
    public func unshare(macId: MACIdentifier, with email: String?) async throws -> MACIdentifier {
        ...
        do {
            ...
            if let email { createQueuedRequest(from: request, type: .unshare, uniqueKey: macId.mac + "-unshare-" + email) }
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    }
    ...
    public func unclaim(macId: MACIdentifier, removeCloudHistory: Bool) async throws -> MACIdentifier {
        ...
        do {
            ...
            createQueuedRequest(from: request, type: .unclaim, uniqueKey: uniqueKey)
            throw RuuviCloudError.api(error.ruuviCloudApiError)
        }
    }
