...
public final class RuuviCloudApiURLSession: NSObject, RuuviCloudApi {
    ...
    public func uploadImage(
        ...
        _ = try await upload(url: url, with: imageData, mimeType: .jpg, progress: { percentage in
            #if DEBUG || ALPHA
...
extension RuuviCloudApiURLSession {
    ...
    private func request<Response: Decodable>(
        ...
        guard Reachability.active else {
            throw RuuviCloudApiError.connection
        }
        ...
        do {
            ...
            throw RuuviCloudApiError.networking(error)
        }

        guard !data.isEmpty else {
            throw RuuviCloudApiError.failedToGetDataFromResponse
        }
