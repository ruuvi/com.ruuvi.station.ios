...
public final class RuuviCloudCanonicalProxy: RuuviCloud {
    ...
    public func update(
        ...
        return restore(sensor: updated, originalMac: originalMacId)
    }
    ...
    public func set(temperatureAccuracy: MeasurementAccuracyType) async throws
    ...
    public func set(humidityAccuracy: MeasurementAccuracyType) async throws
    -> MeasurementAccuracyType {
    ...
    public func set(pressureAccuracy: MeasurementAccuracyType) async throws
    -> MeasurementAccuracyType {
    ...
    public func set(marketingPreference: Bool) async throws -> Bool {
        try await cloud.set(marketingPreference: marketingPreference)
    }
