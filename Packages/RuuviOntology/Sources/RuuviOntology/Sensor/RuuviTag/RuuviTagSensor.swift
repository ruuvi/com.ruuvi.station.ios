...
public extension RuuviTagSensor {
    ...
    func withoutFirmwareVersion() -> RuuviTagSensor {
        RuuviTagSensorStruct(
            version: version,
            firmwareVersion: nil,
            luid: luid,
    ...
    func with(cloudSensor: CloudSensor) -> RuuviTagSensor {
        let sensor = RuuviTagSensorStruct(
            ...
            sharedToPending: cloudSensor.sharedToPending,
    ...
    func with(sharedToPending: [String]) -> RuuviTagSensor {
        RuuviTagSensorStruct(
            version: version,
            firmwareVersion: firmwareVersion,
            luid: luid,
    ...
    func with(lastUpdated: Date?) -> RuuviTagSensor {
        RuuviTagSensorStruct(
            version: version,
            firmwareVersion: firmwareVersion,
            luid: luid,
