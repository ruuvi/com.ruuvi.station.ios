...
public protocol SensorSettings {
    ...
    var displayOrderLastUpdated: Int64? { get }
    var defaultDisplayOrderLastUpdated: Int64? { get }
}
...
public struct SensorSettingsStruct: SensorSettings {
    ...
    public var displayOrderLastUpdated: Int64?
    public var defaultDisplayOrderLastUpdated: Int64?
